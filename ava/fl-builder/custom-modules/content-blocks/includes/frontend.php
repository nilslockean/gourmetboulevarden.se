...
<div class="bb--content-blocks">
    ...
    <?php if ( ! empty( $settings->title_1 ) OR ! empty( $settings->image_1 ) ) : ?>
    ...
    <?php if ( ! empty( $settings->title_2 ) OR ! empty( $settings->image_2 ) ) : ?>
    ...
    <?php if ( ! empty( $settings->title_3 ) OR ! empty( $settings->image_3 ) ) : ?>
    ...
    <?php if ( ! empty( $settings->title_4 ) OR ! empty( $settings->image_4 ) ) : ?>
