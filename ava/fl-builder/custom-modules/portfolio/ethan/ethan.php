...
class Ava_Portfolio_Ethan extends FLBuilderModule {
    ...
    public function enqueue_scripts() {
        ...
        if( $this->settings && $this->settings->load_animation == 'yes' ) {
            $this->add_js( 'scrollreveal', get_theme_file_uri( '/fl-builder/assets/js/scrollreveal.js' ), array( 'jquery' ), '1.5.9', true );
        }
 ...
 */
FLBuilder::register_module('Ava_Portfolio_Ethan', array(
    'first'       => array(
