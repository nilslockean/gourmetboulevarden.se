...
if ( ! function_exists( 'ava_scripts' ) ) :
	...
	function ava_scripts() {
		...
		if ( is_child_theme() ) {
			...
			wp_enqueue_style( 'ava-child-style', get_theme_file_uri( '/style.css' ), false, '1.5.9', 'all' );
		} else {
		...
		if ( SCRIPT_DEBUG || AVA_DEBUG ) {
			...
			// Vendor scripts.
			wp_enqueue_script( 'dropkick', get_theme_file_uri( '/assets/js/vendors/dropkick.js' ), array( 'jquery' ), '1.5.9', true );
			wp_enqueue_script( 'fitvids', get_theme_file_uri( '/assets/js/vendors/fitvids.js' ), array( 'jquery' ), '1.5.9', true );
			wp_enqueue_script( 'headroom', get_theme_file_uri( '/assets/js/vendors/headroom.js' ), array( 'jquery' ), '1.5.9', true );
			wp_enqueue_script( 'infinitescroll', get_theme_file_uri( '/assets/js/vendors/infinitescroll.js' ), array( 'jquery' ), '1.5.9', true );
			wp_enqueue_script( 'ava-photoswipe', get_theme_file_uri( '/assets/js/vendors/photoswipe.js' ), array( 'jquery' ), '1.5.9', true );
			wp_enqueue_script( 'ava-photoswipe-ui', get_theme_file_uri( '/assets/js/vendors/photoswipe-ui-default.js' ), array( 'jquery' ), '1.5.9', true );
			wp_enqueue_script( 'sticky', get_theme_file_uri( '/assets/js/vendors/sticky.js' ), array( 'jquery' ), '1.5.9', true );
			wp_enqueue_script( 'superfish', get_theme_file_uri( '/assets/js/vendors/superfish.js' ), array( 'jquery' ), '1.5.9', true );
			wp_enqueue_script( 'svg4everybody', get_theme_file_uri( '/assets/js/vendors/svg4everybody.js' ), array( 'jquery' ), '1.5.9', true );

			// Custom scripts.
			wp_enqueue_script( 'ava-navigation', get_theme_file_uri( '/assets/js/custom/navigation.js' ), array( 'jquery' ), '1.5.9', true );
			wp_enqueue_script( 'ava-skip-link-focus-fix', get_theme_file_uri( '/assets/js/custom/skip-link-focus-fix.js' ), array( 'jquery' ), '1.5.9', true );
			wp_enqueue_script( 'ava-typography', get_theme_file_uri( '/assets/js/custom/typography.js' ), array( 'jquery' ), '1.5.9', true );
			wp_enqueue_script( 'ava-global', get_theme_file_uri( '/assets/js/custom/global.js' ), array( 'jquery' ), '1.5.9', true );

			// Load the Likes script, only on singular posts.
			if ( is_singular( 'post' ) ) {
				wp_enqueue_script( 'ava-likes', get_theme_file_uri( '/assets/js/custom/likes.js' ), array( 'jquery' ), '1.5.9', true );
			}
			...
			if ( ava_is_woocommerce_activated() ) {
				...
				wp_enqueue_script( 'ava-woocommerce', get_theme_file_uri( '/assets/js/custom/woocommerce/ava-woocommerce.js' ), array( 'jquery' ), '1.5.9', true );
				wp_enqueue_script( 'ava-woocommerce-add-to-cart', get_theme_file_uri( '/assets/js/custom/woocommerce/woocommerce-add-to-cart.js' ), array( 'jquery' ), '1.5.9', true );
				wp_enqueue_script( 'ava-woocommerce-cart', get_theme_file_uri( '/assets/js/custom/woocommerce/woocommerce-cart.js' ), array( 'jquery' ), '1.5.9', true );
				wp_enqueue_script( 'ava-woocommerce-shop', get_theme_file_uri( '/assets/js/custom/woocommerce/woocommerce-shop.js' ), array( 'jquery' ), '1.5.9', true );
			}
			...
			wp_enqueue_script( 'ava-vendors-min', get_theme_file_uri( '/assets/js/vendors.min.js' ), array( 'jquery' ), '1.5.9', true );
			wp_enqueue_script( 'ava-custom-min', get_theme_file_uri( '/assets/js/custom.min.js' ), array( 'jquery' ), '1.5.9', true );

			if ( ava_is_woocommerce_activated() ) {
				wp_enqueue_script( 'ava-woocommerce-min', get_theme_file_uri( '/assets/js/woocommerce.min.js' ), array( 'jquery' ), '1.5.9', true );
			}
...
function ava_enqueue_admin_style() {
	wp_enqueue_style( 'ava-admin-style', get_theme_file_uri( '/assets/css/admin-style.css' ), false, '1.5.9', 'all' );
...
function ava_enqueue_admin_script( $hook ) {
	...
	if ( 'edit.php' !== $hook ) {
		wp_enqueue_script( 'ava-post-meta', get_theme_file_uri( '/assets/js/admin/post-meta.js' ), array( 'jquery' ), '1.5.9', true );
		wp_enqueue_script( 'wp-color-picker' );
	}

	if ( 'widgets.php' === $pagenow || isset( $wp_customize ) ) {
		wp_enqueue_media();
		wp_enqueue_script( 'widget-image-upload', get_theme_file_uri( '/assets/js/admin/media.js' ), array( 'jquery' ), '1.5.9', true );
