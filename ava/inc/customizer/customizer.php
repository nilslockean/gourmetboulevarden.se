...
function ava_customize_preview_js() {
	wp_enqueue_script( 'ava-customize-preview', get_theme_file_uri( '/assets/js/admin/customize-preview' . AVA_ASSET_SUFFIX . '.js' ), array( 'customize-preview' ), '1.5.9', true );
}
...
function ava_customize_events_enqueue_scripts() {
	wp_enqueue_script( 'ava-customize-events', get_theme_file_uri( '/assets/js/admin/customize-events' . AVA_ASSET_SUFFIX . '.js' ), array( 'customize-controls' ), '1.5.9', true );
}
...
function ava_customize_live_js() {
	wp_enqueue_script( 'ava-customize-live', get_theme_file_uri( '/assets/js/admin/customize-live' . AVA_ASSET_SUFFIX . '.js' ), array( 'customize-preview' ), '1.5.9', true );
}
...
function ava_customize_panel_js() {
	wp_enqueue_script( 'ava-customize-controls', get_theme_file_uri( '/assets/js/admin/customize-controls' . AVA_ASSET_SUFFIX . '.js' ), array(), '1.5.9', true );
}
